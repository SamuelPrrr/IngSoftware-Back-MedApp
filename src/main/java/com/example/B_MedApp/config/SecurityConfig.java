...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/medicos/citas/**").hasAuthority("ROLE_MEDICO")
                        .requestMatchers("api/admin/**").hasAuthority("ROLE_ADMINISTRADOR")
                        .requestMatchers("api/medicamentos").hasAuthority("ROLE_ADMINISTRADOR")
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("*")); // Ajusta esto en producción
